...
/* to show a specfic person using its ID  */
const show = function (id) {
  Person.findById(id)
  .then((person) => console.log(person.toJSON()) )
  .catch(console.error)
  .then(done)
  //5d2b3d0beeb49c09b47f8acc ==> Dhaffaf
}

/* to delete a specfic person using its ID  */
...
const update = function (id, field, value) {
  ...
  // After saving we should get a response from that update 
  .then(person => console.log (person.toJSON()))
  .catch(console.error)
  .then(done)
}
